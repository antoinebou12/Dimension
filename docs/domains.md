...
| **graph** | Pathfinding, coloring | graph/ | tests/graph/ | benches/graph/ | examples/graph/ |
| **tree** | BFS, DFS, Tree/Node | graph/tree/ | tests/tree/ | benches/tree/ | examples/tree/ |
| **cg** | Camera, 3D, quaternion, easing | math/cg, math3d, quaternion, trig, easing | tests/cg/ | benches/cg/ | examples/cg/ |
...
- noise, transforms, colormap, stats, tensor, hash
