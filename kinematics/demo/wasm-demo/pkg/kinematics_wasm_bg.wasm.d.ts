...
export const wasm_bindgen__closure__destroy__h12a98130bbdbd912: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h027e5b6af5ffaf77: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hdbec3385a70c55d6: (a: number, b: number) => void;
